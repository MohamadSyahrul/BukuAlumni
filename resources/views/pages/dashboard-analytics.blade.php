...
@section('title')
    Dashboard analytics - Vuexy - Bootstrap HTML admin template
@endsection
@section('content')
                                ...
                                <li class="timeline-item">
                                    ...
                                    <div class="timeline-event">
                                        ...
                                        <div class="media align-items-center">
                                            <img class="mr-1" src="{{asset('admin/app-assets/images/icons/json.png')}}" alt="data.js')}}on" height="23" />
                                            <h6 class="media-body mb-0">data.js')}}on</h6>
                                        </div>
                                    </div>
                                </li>
                                <li class="timeline-item">
                                    ...
                                    <div class="timeline-event">
                                        ...
                                        <div class="media align-items-center">
                                            <div class="avatar mr-50">
                                                <img src="{{asset('admin/app-assets/images/portrait/small/avatar-s-9.jpg')}}" alt="Avatar" width="38" height="38" />
                                            </div>
                                    ...
                                    <div class="timeline-event">
                                        ...
                                        <div class="avatar-group">
                                            ...
                                            <div data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" data-original-title="Daisy Weber" class="avatar pull-up">
                                                <img src="{{asset('admin/app-assets/images/portrait/small/avatar-s-7.jpg')}}" alt="Avatar" width="33" height="33" />
                                            </div>
                    ...
                    <div class="card card-app-design">
                        <div class="card-body">
                            ...
                            <div class="design-group pt-25">
                                ...
                                <div class="avatar">
                                    <img src="{{asset('admin/app-assets/images/portrait/small/avatar-s-9.jpg')}}" width="34" height="34" alt="Avatar" />
                                </div>
                                <div class="avatar bg-light-danger">
                                    <div class="avatar-content">PI</div>
                                </div>
                                <div class="avatar">
                                    <img src="{{asset('admin/app-assets/images/portrait/small/avatar-s-14.jpg')}}" width="34" height="34" alt="Avatar" />
                                </div>
                                <div class="avatar">
                                    <img src="{{asset('admin/app-assets/images/portrait/small/avatar-s-7.jpg')}}" width="34" height="34" alt="Avatar" />
                                </div>
