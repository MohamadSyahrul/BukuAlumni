           ...
           <div class="form-group row">
            ...
            <div class="form-group row">
             ...
             <div class="form-group row">
              ...
              <div class="col-sm-10">
               <div class="sidebar-brand-text mx-3">
               : {{Carbon\Carbon::parse($mahasiswa->tanggal_wisuda)->translatedFormat('d F Y')}}
               </div>
             </div>
           </div>            
           @endif
...
<div class="modal fade" id="TambahData" tabindex="-1" role="dialog" aria-labelledby="TambahDataLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    ...
    <div class="form-group row">
     <div class="col-lg-3">
       <label class="col-form-label">Tahun Wisuda</label>
     </div>
     <div class="col-lg-8">
      <input type="date" name="tanggal_wisuda" class="form-control" placeholder="Contoh  Bulan ">
    </div>
  </div>
